    ...
    return (
        <section className='about-container'>
            ...
            <article className='about-text'>
                ...
                <p>I applied - and was accepted - to the Turing School of Software & Design in March 2022, and I joined the Frontend Software Engineering program in July as part of the 2207 (Year and Month) cohort. My seven months in the program were the most challenging times of my life, even more so than my previous academic endeavor - but the skills I learned, the relationships I cultivated, and the time spent learning and growing my understanding were more than worth the struggle (both productive and not) I endured. I graduated from Turing in late January 2023, and have been seeking my first job in the industry while keeping my skills sharp and connecting with people throughout the space.</p>
